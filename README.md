...
Перед запуском необходимо заполнить переменную среды `TIN_TOKEN` своим токеном желательно с полным доступом.
...
### По коду и логике
* В случае рестарта приложения алгоритмы не восстанавливают своей работы, а при создании новых они снова будут пытаться сначала купить, 
